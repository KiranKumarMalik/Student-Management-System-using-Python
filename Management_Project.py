...
#button frame
button_frame= LabelFrame(windows,bd=7, bg='cadet blue',width=530, height=140)
...
dobEntry = DateEntry(data_frame1, width=28, background='darkblue', foreground='white', borderwidth=5, year=2000)
...
countries=['ALgeria', 'America', 'Australia','Bahamas','Canada', 'Denmark', 'Egypt', 'France', 'Finland', 'Germany',
           'Holland', 'Hungary', 'India', 'Indonesia', 'Jamaica', 'Libya','Malaysia', 'Nigeria', 'Poland', 'Qatar', 'Russia',
